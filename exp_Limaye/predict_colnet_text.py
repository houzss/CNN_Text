...
parser.add_argument(
    '--cnn_evaluate',
    type=str,
    default=os.path.join(current_path, 'in_out/cnn/cnn_3_2_1.00'),
...
w2v_model = gensim.models.KeyedVectors.load_word2vec_format('E:/w2v/GoogleNews-vectors-negative300.bin',binary=True)
# w2v_model = gensim.models.KeyedVectors.load_word2vec_format('E:/w2v/223/model.bin',binary=True)
